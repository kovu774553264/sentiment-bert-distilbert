...
model = DistilBertForSequenceClassification.from_pretrained('distilbert_base_uncased', num_labels=3)
...
model.save_pretrained('model/distilbert_sentiment_3')
tokenizer.save_pretrained('model/distilbert_sentiment_3')

print("Model and tokenizer saved to 'model/distilbert_sentiment_3'")
