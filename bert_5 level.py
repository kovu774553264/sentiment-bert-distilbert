...
model = BertForSequenceClassification.from_pretrained('bert_base_uncased', num_labels=5)
...
model.save_pretrained('model/bert_sentiment_5')
tokenizer.save_pretrained('model/bert_sentiment_5')

print("Model and tokenizer saved to 'model/bert_sentiment_5'")
